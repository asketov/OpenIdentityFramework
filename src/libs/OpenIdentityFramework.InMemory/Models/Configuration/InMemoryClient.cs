...
public class InMemoryClient : AbstractClient<InMemoryClientSecret>
{
    public InMemoryClient(
        ...
        IReadOnlyCollection<InMemoryClientSecret> secrets,
    ...
    public IReadOnlyCollection<InMemoryClientSecret> Secrets { get; }
    ...
    public override IReadOnlyCollection<InMemoryClientSecret> GetSecrets()
    {
        return Secrets;
    }
