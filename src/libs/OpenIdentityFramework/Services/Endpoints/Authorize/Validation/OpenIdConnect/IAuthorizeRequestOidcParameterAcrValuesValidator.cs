...
public interface IAuthorizeRequestOidcParameterAcrValuesValidator<TRequestContext, TClient, TClientSecret>
    where TRequestContext : class, IRequestContext
    where TClient : AbstractClient<TClientSecret>
    where TClientSecret : AbstractClientSecret, IEquatable<TClientSecret>
{
    Task<AuthorizeRequestOidcParameterAcrValuesValidationResult> ValidateAcrValuesOidcParameterAsync(
