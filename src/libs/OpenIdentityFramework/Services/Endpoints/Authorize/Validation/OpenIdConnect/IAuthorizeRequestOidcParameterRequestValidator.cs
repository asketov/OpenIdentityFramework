...
public interface IAuthorizeRequestOidcParameterRequestValidator<TRequestContext, TClient, TClientSecret>
    where TRequestContext : AbstractRequestContext
    where TClient : AbstractClient<TClientSecret>
    where TClientSecret : AbstractSecret
{
    Task<AuthorizeRequestOidcParameterRequestValidationResult> ValidateRequestOidcParameterAsync(
